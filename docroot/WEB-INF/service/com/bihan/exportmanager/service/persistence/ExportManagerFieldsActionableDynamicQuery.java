 ...
 * @generated
 */
public abstract class ExportManagerFieldsActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ExportManagerFieldsActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(ExportManagerFieldsLocalServiceUtil.getService());
		setClass(ExportManagerFields.class);

		setClassLoader(com.bihan.exportmanager.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("exportManagerFieldsId");
	}
}