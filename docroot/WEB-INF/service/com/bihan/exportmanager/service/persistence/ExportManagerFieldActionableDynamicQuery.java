 ...
 * @generated
 */
public abstract class ExportManagerFieldActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ExportManagerFieldActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ExportManagerFieldLocalServiceUtil.getService());
		setClass(ExportManagerField.class);

		setClassLoader(com.bihan.exportmanager.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("exportManagerFieldId");
	}
}